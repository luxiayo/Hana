...
struct AccountVideoListScreen: View {
    ...
    private var content: some View {
        ...
        case .loaded(let page):
            ...
            if page.videos.isEmpty {
                emptyStateView(title: emptyTitle, systemImage: "rectangle.stack.badge.play")
            } else if videos.isEmpty {
                emptyStateView(title: "没有符合条件的内容", systemImage: "line.3.horizontal.decrease.circle")
            } else {
                List {
    ...
    @ViewBuilder
    private func emptyStateView(title: String, systemImage: String) -> some View {
        VStack(spacing: 8) {
