...
struct ProfileScreen: View {
    ...
    private func loadLocalCounts() {
        let persistence = JSONPersistenceManager.shared
        watchHistoryCount = persistence.loadWatchHistory().filter(\.isHistoryEligible).count
